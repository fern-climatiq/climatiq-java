...
public final class GetLcaActivities {
  private GetLcaActivities() {
  }
  ...
  public static final class Request {
    ...
    public String toString() {
      return "GetLcaActivities.Request{" + "authOverride: " + authOverride + ", sector: " + sector + ", category: " + category + ", source: " + source + ", region: " + region + ", year: " + year + ", calculationMethod: " + calculationMethod + ", lcaActivity: " + lcaActivity + ", activityId: " + activityId + "}";
    }
