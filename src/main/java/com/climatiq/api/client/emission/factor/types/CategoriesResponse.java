...
@JsonDeserialize(
    builder = CategoriesResponse.Builder.class
)
public final class CategoriesResponse {
  ...
  CategoriesResponse(List<String> results) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CategoriesResponse && equalTo((CategoriesResponse) other);
  }

  private boolean equalTo(CategoriesResponse other) {
  ...
  public String toString() {
    return "CategoriesResponse{" + "results: " + results + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(CategoriesResponse other) {
    ...
    public CategoriesResponse build() {
      return new CategoriesResponse(results);
    }
  }
}
