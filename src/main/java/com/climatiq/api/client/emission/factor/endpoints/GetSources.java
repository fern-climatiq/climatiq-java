...
public final class GetSources {
  ...
  public static final class Request {
    ...
    private final Optional<String> iactivityIdd;
    ...
    Request(Optional<BearerAuth> authOverride, Optional<String> sector, Optional<String> category,
      ...
      this.iactivityIdd = iactivityIdd;
    }
    ...
    public Optional<String> getIactivityIdd() {
      return iactivityIdd;
    }
    ...
    public String toString() {
      return "GetSources.Request{" + "authOverride: " + authOverride + ", sector: " + sector + ", category: " + category + ", source: " + source + ", region: " + region + ", year: " + year + ", calculationMethod: " + calculationMethod + ", lcaActivity: " + lcaActivity + ", iactivityIdd: " + iactivityIdd + "}";
    }
    ...
    public static final class Builder {
      ...
      private Optional<String> iactivityIdd = Optional.empty();
      ...
      public Builder from(Request other) {
        ...
        iactivityIdd(other.getIactivityIdd());
        return this;
      }
      ...
      public Builder iactivityIdd(Optional<String> iactivityIdd) {
        this.iactivityIdd = iactivityIdd;
        return this;
      }

      public Builder iactivityIdd(String iactivityIdd) {
        this.iactivityIdd = Optional.of(iactivityIdd);
        return this;
      }

      public Request build() {
        return new Request(authOverride, sector, category, source, region, year, calculationMethod, lcaActivity, iactivityIdd);
      }
    }
  }
}
