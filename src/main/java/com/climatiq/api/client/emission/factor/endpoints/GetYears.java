...
public final class GetYears {
  ...
  public static final class Request {
    ...
    Request(Optional<BearerAuth> authOverride, Optional<String> category, Optional<String> source,
        Optional<String> region, Optional<String> year, Optional<String> calculationMethod,
        Optional<String> lcaActivity, Optional<String> activityId) {
    ...
    private boolean equalTo(Request other) {
      return authOverride.equals(other.authOverride) && category.equals(other.category) && source.equals(other.source) && region.equals(other.region) && year.equals(other.year) && calculationMethod.equals(other.calculationMethod) && lcaActivity.equals(other.lcaActivity) && activityId.equals(other.activityId);
    }

    @Override
    public int hashCode() {
      if (_cachedHashCode == 0) {
        _cachedHashCode = Objects.hash(this.authOverride, this.category, this.source, this.region, this.year, this.calculationMethod, this.lcaActivity, this.activityId);
      }
    ...
    public String toString() {
      return "GetYears.Request{" + "authOverride: " + authOverride + ", category: " + category + ", source: " + source + ", region: " + region + ", year: " + year + ", calculationMethod: " + calculationMethod + ", lcaActivity: " + lcaActivity + ", activityId: " + activityId + "}";
    }
    ...
    public static final class Builder {
      ...
      public Request build() {
        return new Request(authOverride, category, source, region, year, calculationMethod, lcaActivity, activityId);
      }
    }
  }
}
