...
public final class GetSectors {
  ...
  public static final class Request {
    ...
    public String toString() {
      return "GetSectors.Request{" + "authOverride: " + authOverride + ", sector: " + sector + ", category: " + category + ", source: " + source + ", region: " + region + ", year: " + year + ", calculationMethod: " + calculationMethod + ", lcaActivity: " + lcaActivity + ", activityId: " + activityId + "}";
    }
