...
@JsonDeserialize(
    using = GetUnitTypesException.Deserializer.class
)
public final class GetUnitTypesException extends Exception {
  private final Value value;

  private int statusCode;

  private GetUnitTypesException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetUnitTypesException other(Object unknownValue, int statusCode) {
    return new GetUnitTypesException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetUnitTypesException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetUnitTypesException> {
    @Override
    public GetUnitTypesException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetUnitTypesException(value, statusCode);
    }
  }
}
