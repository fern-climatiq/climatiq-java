...
public final class GetUnitTypes {
  ...
  public static final class Request {
    ...
    public String toString() {
      return "GetUnitTypes.Request{" + "authOverride: " + authOverride + ", sector: " + sector + ", category: " + category + ", source: " + source + ", region: " + region + ", year: " + year + ", calculationMethod: " + calculationMethod + ", lcaActivity: " + lcaActivity + ", activityId: " + activityId + "}";
    }
