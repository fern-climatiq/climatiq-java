...
public final class TravelFlights {
  private TravelFlights() {
  }

  public static final class Request {
    private final Optional<BearerAuth> authOverride;

    private final TravelFlightsRequest body;

    private int _cachedHashCode;

    Request(Optional<BearerAuth> authOverride, TravelFlightsRequest body) {
    ...
    public TravelFlightsRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "TravelFlights.Request{" + "authOverride: " + authOverride + ", body: " + body + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(TravelFlightsRequest body);
    ...
    static final class Builder implements BodyStage, _FinalStage {
      private TravelFlightsRequest body;
      ...
      @Override
      public _FinalStage body(TravelFlightsRequest body) {
        this.body = body;
        return this;
      }
