...
public final class Estimate {
  ...
  public static final class Request {
    ...
    private final customActivityRequest body;

    private int _cachedHashCode;

    Request(Optional<BearerAuth> authOverride, customActivityRequest body) {
    ...
    public customActivityRequest getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(customActivityRequest body);
    ...
    static final class Builder implements BodyStage, _FinalStage {
      private customActivityRequest body;
      ...
      @Override
      public _FinalStage body(customActivityRequest body) {
        this.body = body;
        return this;
      }
