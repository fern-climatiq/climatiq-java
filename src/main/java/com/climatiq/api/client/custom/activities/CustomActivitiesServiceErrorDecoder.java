...
final class CustomActivitiesServiceErrorDecoder implements ErrorDecoder {
  @Override
  public Exception decode(String methodKey, Response response) {
    try {
      ...
      if (methodKey.contains("batchCustomActivities")) {
        return decodeException(response, BatchCustomActivitiesException.class);
      }
    }
    catch (IOException e) {
    }
