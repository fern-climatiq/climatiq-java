...
@JsonDeserialize(
    using = MemoryException.Deserializer.class
)
public final class MemoryException extends Exception {
  ...
  private MemoryException(Value value, int statusCode) {
    this.value = value;
  ...
  public static MemoryException other(Object unknownValue, int statusCode) {
    return new MemoryException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "MemoryException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<MemoryException> {
    @Override
    public MemoryException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new MemoryException(value, statusCode);
    }
  }
}
