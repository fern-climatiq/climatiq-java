...
@JsonDeserialize(
    using = MetadataException.Deserializer.class
)
public final class MetadataException extends Exception {
  ...
  private MetadataException(Value value, int statusCode) {
    this.value = value;
  ...
  public static MetadataException other(Object unknownValue, int statusCode) {
    return new MetadataException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "MetadataException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<MetadataException> {
    @Override
    public MetadataException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new MetadataException(value, statusCode);
    }
  }
}
