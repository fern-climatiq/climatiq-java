...
public final class Storage {
  ...
  public static final class Request {
    ...
    private final StorageRequest body;

    private int _cachedHashCode;

    Request(Optional<BearerAuth> authOverride, ProviderId provider, StorageRequest body) {
    ...
    public String toString() {
      return "Storage.Request{" + "authOverride: " + authOverride + ", provider: " + provider + ", body: " + body + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(StorageRequest body);
    }
    ...
    static final class Builder implements ProviderStage, BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(StorageRequest body) {
        this.body = body;
        return this;
      }
