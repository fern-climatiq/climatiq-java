...
public final class Estimate {
  ...
  public static final class Request {
    ...
    private final EstimateRequest body;

    private int _cachedHashCode;

    Request(Optional<BearerAuth> authOverride, EstimateRequest body) {
    ...
    public EstimateRequest getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(EstimateRequest body);
    ...
    static final class Builder implements BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(EstimateRequest body) {
        this.body = body;
        return this;
      }
